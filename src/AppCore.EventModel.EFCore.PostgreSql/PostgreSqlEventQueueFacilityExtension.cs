...
{
    /// <summary>
    /// Provides a PostgreSql extension for the <see cref="EventQueueFacilityExtension"/>.
    /// </summary>
    /// <typeparam name="TTag">The data provider tag.</typeparam>
    /// <typeparam name="TDbContext">The type of the <see cref="DbContext"/>.</typeparam>
    public class PostgreSqlEventQueueFacilityExtension<TTag, TDbContext> : FacilityExtension
